...
$(document).ready(function(){
    $('a[data-type="popup"]').live('click',function(e){
        console.log(e);
        e.preventDefault();
        var link = $(this).attr('href')+'?popup';
        ...
        if($(this).attr('data-name')){
            options.windowName = $(this).attr('data-name');
        }
        else {
            options.windowName = 'popup';
        }
        options.windowURL = link;
