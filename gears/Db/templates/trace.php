...
?>
<?php echo t('<b>База данных:</b> %d <i class="icon icon-time"></i> %.3f<i class="icon icon-leaf"></i>%s', sizeof($queries),$total_time,File::fromBytes($memory)); ?> <?php if($queries):?><a id="db-trace-queries-handler" class="btn btn-mini"><i class="icon icon-eye-open"></i></a>
