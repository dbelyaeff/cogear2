...
final class HTML {
    ...
    public static $allowed_attributes = array(
        ...
        'input' => array('required','type', 'value', 'disabled', 'checked', 'name','placeholder','tabindex'),
        'select' => array('required','type', 'disabled', 'name','multiple','tabindex'),
        'option' => array('selected','value'),
        'textarea' => array('required','rows', 'cols', 'name', 'disabled','placeholder','tabindex'),
