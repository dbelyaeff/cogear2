...
final class HTML {
    ...
    public static $allowed_attributes = array(
        ...
        'input' => array('required','type', 'value', 'disabled', 'checked', 'name','placeholder'),
        'select' => array('required','type', 'disabled', 'name','multiple'),
        'option' => array('selected','value'),
        'textarea' => array('required','rows', 'cols', 'name', 'disabled','placeholder'),
