<?=t('<p class="alert alert-warning">Welcome to <b>Cogear framework</b>! Thank you for choosing this product. It\'s a small and fast PHP-framework which provides wide functionality and flexibiliry for your work.
...
<p align="center">
    <a class="btn btn-primary" href="<?=l('/install/check')?>" class="button"><?=t('Start!')?></a>
</p>