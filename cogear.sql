...
--
-- Host: localhost
-- Generation Time: May 23, 2012 at 08:06 PM
...
(1, 1, 'блог админа', 'admin', 'Всем привет!', '/blogs/admin.jpg', 0, 0, 1, 0, 0, 0),
(2, 1, 'Новости', 'news', '<p>Новости сайта.</p>\r\n', '', 2, 0, 1, 0, 0, 1335122958),
(30, 9, 'CuamckuyKot', 'Cuamckuy', 'It''s my personal blog.', '', 0, 0, 1, 0, 0, 1337466816);
...
INSERT INTO `posts` (`id`, `aid`, `bid`, `name`, `body`, `comments`, `allow_comments`, `views`, `rating`, `created_date`, `last_update`, `published`, `ip`, `front`, `front_time`) VALUES
(28, 1, 1, 'One new post!', 'Som content.', 19, 1, 663, 0, 1334578261, 1337786366, 1, '127.0.0.1', 1, 1337283551),
(69, 9, 30, 'Как я провел этим летом', 'Мой первый пост!', 0, 0, 0, 0, 1337786393, 1337786393, 1, '127.0.0.1', 0, 0),
(70, 1, 2, 'Новость дня', 'Сайт открылся!', 0, 0, 1, 0, 1337786418, 1337789130, 1, '127.0.0.1', 1, 1337789130);
...
(1, 'admin', 'fa4654b18a5442c0914cc1c6b536cd73', 'c535ef8cb9b02af1b3907c5ab8d4009e', 'admin@cogear.ru', 'Беляев Дмитрий', '/avatars/1/1.jpg', 1, 2, 0, 1, 0, 0, 0, 1333104704, 1337789128),
(9, 'Cuamckuy', '2fc1f3d9c3aad0014f802083a78eb8e4', '3282f6a3b2df4658a051f89c03fcc3f7', 'cuamckuy@gmail.com', 'Дима', '', 100, 1, 0, 1, 0, 0, 0, 1337466816, 1337788679);
